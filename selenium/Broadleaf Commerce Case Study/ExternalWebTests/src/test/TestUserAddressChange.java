...
public class TestUserAddressChange extends UserDataTest{
	...
	public void testAddAddress(String firstName,String lastName, String phone, String addr1, String addr2, String city, 
		...
		try{
			...
			submitAddress(firstName, lastName, phone, addr1, addr2, city, state, postal, addrName);
	...
	private void submitAddress(
			String firstName, String lastName, String phone, String addr1, String addr2,
			String city, State state, String postal, String addrName) {
		fDriver.get(fBaseUrl);	
